...
url: string;
  constructor(private activatedRoute: ActivatedRoute, private http: HttpClient,
      ...
      private toastCtrl: ToastController, private service:AppService) { }

  ngOnInit() {
    this.catTitle = this.activatedRoute.snapshot.paramMap.get('catTitle');
    this.service.getCategoryId(this.catTitle).subscribe(
      (res: any) => {
        console.log(res)
        this.service.getArticlesByCategs(res.id).subscribe(
          res => {
            this.articles = res
